  ...
  <div class="custom-wrap">
    <el-row class="breadcrumb-style">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>网页防篡改</el-breadcrumb-item>
      </el-breadcrumb>
    </el-row>
...
export default {
  ...
  methods: {
    getData(page) {
      var t = this
      var url = '/user/get_web_page_tamper_proof_list'
    ...
    handleEdit(data) {
      this.$router.push('/user/page-tamper-proof-edit/' + data.rule_name)
    },
    handleAdd() {
      this.$router.push('/user/page-tamper-proof-edit/new')
    },
    handleDelete(data) {
      var t = this
      t.loading = true
      var url = '/user/delete_web_page_tamper_proof'
    ...
    onClickChangeOrderSubmit(index, value, operate) {
      var t = this
      var url = '/user/exchange_web_page_tamper_proof_priority'
    ...
    onChangeRuleStatus(value) {
      var t = this
      var url = '/user/edit_web_page_tamper_proof_status'
