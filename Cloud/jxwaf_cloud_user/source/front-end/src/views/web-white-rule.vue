  ...
  <div class="custom-wrap">
    <el-row class="breadcrumb-style">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>Web白名单规则</el-breadcrumb-item>
      </el-breadcrumb>
    </el-row>
          ...
          <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="rule_action" label="执行动作">
              <template #default="scope">
                <el-tag v-if="scope.row.rule_action == 'web_bypass'" size="small">Web安全防护加白</el-tag>
...
export default {
  ...
  methods: {
    getData(page) {
      var t = this
      var url = '/user/get_web_white_rule_list'
    ...
    handleEdit(data) {
      this.$router.push('/user/web-white-rule-edit/' + data.rule_name)
    },
    handleAdd() {
      this.$router.push('/user/web-white-rule-edit/new')
    },
    handleDelete(data) {
      var t = this
      t.loading = true
      var url = '/user/delete_web_white_rule'
    ...
    onClickChangeOrderSubmit(index, value, operate) {
      var t = this
      var url = '/user/exchange_web_white_rule_priority'
    ...
    onChangeRuleStatus(value) {
      var t = this
      var url = '/user/edit_web_white_rule_status'
