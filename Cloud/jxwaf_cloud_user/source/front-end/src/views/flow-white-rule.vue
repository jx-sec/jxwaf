  ...
  <div class="custom-wrap">
    <el-row class="breadcrumb-style">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>流量白名单规则</el-breadcrumb-item>
      </el-breadcrumb>
    </el-row>
          ...
          <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="rule_action" label="执行动作">
              <template #default="scope">
                <el-tag v-if="scope.row.rule_action == 'flow_bypass'" size="small">流量安全防护加白</el-tag>
...
export default {
  ...
  methods: {
    getData(page) {
      var t = this
      var url = '/user/get_flow_white_rule_list'
    ...
    handleEdit(data) {
      this.$router.push('/user/flow-white-rule-edit/' + data.rule_name)
    },
    handleAdd() {
      this.$router.push('/user/flow-white-rule-edit/new')
    },
    handleDelete(data) {
      var t = this
      t.loading = true
      var url = '/user/delete_flow_white_rule'
    ...
    onClickChangeOrderSubmit(index, value, operate) {
      var t = this
      var url = '/user/exchange_flow_white_rule_priority'
    ...
    onChangeRuleStatus(value) {
      var t = this
      var url = '/user/edit_flow_white_rule_status'
