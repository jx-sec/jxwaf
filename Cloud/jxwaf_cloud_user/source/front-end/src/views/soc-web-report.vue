  ...
  <div class="echart-container">
    <el-row class="breadcrumb-style">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item :to="{ path: '/soc-web-report' }">运营中心</el-breadcrumb-item>
        <el-breadcrumb-item>Web安全报表</el-breadcrumb-item>
      </el-breadcrumb>
    </el-row>
            ...
            <div class="card-content">
              <div class="card-text-wrapper">
                ...
                <div :class="`card-badge trend-${countTotle.trend === 'flat' ? 'stable' : countTotle.trend}`">
                  ...
                  <span  v-if="countTotle.trend != 'flat'">{{ countTotle.previous > 0 ? ((countTotle.current - countTotle.previous ) / countTotle.previous * 100).toFixed(1) : 0 }} %</span>
                  <span  v-if="countTotle.trend == 'flat'">0%</span>
                </div>
                <!-- <div class="card-badge trend-up">
                  <span class="card-badge-icon"><el-icon><CaretTop /></el-icon></span>
                  <span>20%</span>
                </div> -->
              </div>
            </div>
            ...
            <div class="card-content">
              <div class="card-text-wrapper">
                ...
                <div :class="`card-badge trend-${apiCountTotle.trend === 'flat' ? 'stable' : apiCountTotle.trend}`">
                  ...
                  <span  v-if="countTotle.trend != 'flat'">{{ apiCountTotle.previous > 0 ? ((apiCountTotle.current - apiCountTotle.previous ) / apiCountTotle.previous * 100).toFixed(1) : 0 }} %</span>
                  <span  v-if="countTotle.trend == 'flat'">0%</span>
                </div>
              </div>
            </div>
            ...
            <div class="card-content">
              <div class="card-text-wrapper">
                ...
                <div :class="`card-badge trend-${ipCountTotle.trend === 'flat' ? 'stable' : ipCountTotle.trend}`">
                  ...
                  <span  v-if="countTotle.trend != 'flat'">{{ ipCountTotle.previous > 0 ? ((ipCountTotle.current - ipCountTotle.previous ) / ipCountTotle.previous * 100).toFixed(1) : 0 }} %</span>
                  <span  v-if="countTotle.trend == 'flat'">0%</span>
                </div>
              </div>
            </div>
            ...
            <div class="card-content">
              <div class="card-text-wrapper">
                ...
                <div :class="`card-badge trend-${isocodeCountTotle.trend === 'flat' ? 'stable' : isocodeCountTotle.trend}`">
                  ...
                  <span  v-if="countTotle.trend != 'flat'">{{ isocodeCountTotle.previous > 0 ? ((isocodeCountTotle.current - isocodeCountTotle.previous ) / isocodeCountTotle.previous * 100).toFixed(1) : 0 }} %</span>
                  <span  v-if="countTotle.trend == 'flat'">0%</span>
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    gatAttackGeoip() {
      var t = this
      var oData = []
      var _url = '/user/get_web_attack_geoip'
      var _data = {
    ...
    getCountTotle() {
      ...
      var postUrl = '/user/get_web_attack_count_total'
      var oData = {
        from_time: formatterDateTime(t.pickerTime[0]),
        to_time: formatterDateTime(t.pickerTime[1])
      }
    ...
    getApiCountTotle() {
      ...
      var postUrl = '/user/get_web_attack_api_count_total'
      var oData = {
        from_time: formatterDateTime(t.pickerTime[0]),
        to_time: formatterDateTime(t.pickerTime[1])
      }
    ...
    getIsocodeCountTotle() {
      ...
      var postUrl = '/user/get_web_attack_isocode_count_total'
      var oData = {
        from_time: formatterDateTime(t.pickerTime[0]),
        to_time: formatterDateTime(t.pickerTime[1])
      }
    ...
    getIpCountTotle() {
      ...
      var postUrl = '/user/get_web_attack_ip_count_total'
      var oData = {
        from_time: formatterDateTime(t.pickerTime[0]),
        to_time: formatterDateTime(t.pickerTime[1])
      }
    ...
    getCountTrend() {
      ...
      var postUrl = '/user/get_web_attack_count_trend'
      var oData = {
        from_time: formatterDateTime(t.pickerTime[0]),
        to_time: formatterDateTime(t.pickerTime[1])
      }
    ...
    getApiTop() {
      ...
      var postUrl = '/user/get_web_attack_api_top'
      var oData = {
        from_time: formatterDateTime(t.pickerTime[0]),
        to_time: formatterDateTime(t.pickerTime[1])
      }
    ...
    getTypeTop() {
      ...
      var postUrl = '/user/get_web_attack_type_top'
      var oData = {
        from_time: formatterDateTime(t.pickerTime[0]),
        to_time: formatterDateTime(t.pickerTime[1])
      }
    ...
    getIpTop() {
      ...
      var postUrl = '/user/get_web_attack_ip_top'
      var oData = {
        from_time: formatterDateTime(t.pickerTime[0]),
        to_time: formatterDateTime(t.pickerTime[1])
      }
    ...
    getIsocodeTop() {
      ...
      var postUrl = '/user/get_web_attack_isocode_top'
      var oData = {
        from_time: formatterDateTime(t.pickerTime[0]),
        to_time: formatterDateTime(t.pickerTime[1])
      }
