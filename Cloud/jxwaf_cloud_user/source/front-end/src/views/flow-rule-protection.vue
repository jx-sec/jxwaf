  ...
  <div class="custom-wrap">
    <el-row class="breadcrumb-style">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>流量防护规则</el-breadcrumb-item>
      </el-breadcrumb>
    </el-row>
...
export default {
  ...
  methods: {
    getData(page) {
      var t = this
      var url = '/user/get_flow_rule_protection_list'
    ...
    handleEdit(data) {
      this.$router.push('/user/flow-rule-protection-edit/' + data.rule_name)
    },
    handleAdd() {
      this.$router.push('/user/flow-rule-protection-edit/new')
    },
    handleDelete(data) {
      var t = this
      t.loading = true
      var url = '/user/delete_flow_rule_protection'
    ...
    onClickChangeOrderSubmit(index, value, operate) {
      var t = this
      var url = '/user/exchange_flow_rule_protection_priority'
    ...
    onChangeRuleStatus(value) {
      var t = this
      var url = '/user/edit_flow_rule_protection_status'
